...
public class MyDBInfo {
	public static final String MYSQL_USERNAME = "ccs108kcwijaya";
	public static final String MYSQL_PASSWORD = "fmP8rWZkxlwFTnVc";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_kcwijaya";
}
